...
/**
 * This data class extends the TransactionResponse class
 * and represents a freedom pay response object.  It is
 * called by FreedomPayPaymentDevice and used to parcel
 * POS transaction responses to / from XML.  This class
...
public class FreedomPayTransactionResponse extends TransactionResponse {
