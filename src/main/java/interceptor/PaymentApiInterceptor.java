...
//
//
//                // TODO: This is redundant or conflicting - REMOVE
...
//                .url(host + Constant.CHECK_HEARTBEAT_API)
//                .build();
//
...
//        } catch (Exception e) {
//            System.out.println("SSL Peer Unverified Exception <><><> WTF");
//            e.printStackTrace();
...
//                        .cacheControl(CacheControl.FORCE_NETWORK)
//                        .url(host + Constant.GENERATE_TOKEN_API)
//                        .build();
//
